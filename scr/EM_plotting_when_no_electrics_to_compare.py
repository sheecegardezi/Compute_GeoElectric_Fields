...
"""
 ...
 Outputs (in "out" folder)
   1) Comparison between measured and modell.
ed time series in the time
...
"""
import functions_EM_plotting as femp
...
#                                             )
    ...
    m_e_field[:,v,:], std_Efield[:,v,:] = femp.read_comp_elc(out_path, 
                                                                ip, 
                                                                samp, 
                                                                storm, 
                                                                mode
